            ...
            <div className="logInForm">
                ...
                <div className="rightContent">
                    <form >
                        ...
                        <input style={{ border: props.credentials.password != props.credentials.reEnteredPassword ? "2px solid red" : "2px solid green" }} value={props.credentials.reEnteredPassword} onChange={(event) => { props.setCredentials({ ...props.credentials, reEnteredPassword: event.target.value }) }} type="password" name="" id="" />
